...
fun showMyAge(currentAge: Int = 23) {
...
fun variablesAlfaNumericas() {
    ...
    //String
    val stringExample: String = "Hola soy Mario"
    val stringExample2 = "Mario"
...
fun variablesNumericas() {
    ...
    //Var permite modificarse, val NO.
    var age2: Int = 30
    age2 = 29
    ...
    //Float(poner siempre la f al final)
